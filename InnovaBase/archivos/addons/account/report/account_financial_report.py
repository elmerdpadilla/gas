...
class report_account_common(report_sxw.rml_parse, common_report_header):
    ...
    def __init__(self, cr, uid, name, context=None):
        ...
        self.financial_ids=self.pool.get('account.financial.report').search(cr,uid,[],context=context)
        self.financial_obj=self.pool.get('account.financial.report').browse(cr,uid,self.financial_ids,context=context)
        ...
        self.localcontext.update( {
            ...
            'fecha':self.fecha,
            'financial_obj':self.financial_obj,
        })
