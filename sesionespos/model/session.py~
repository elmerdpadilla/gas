...
class sessionpos(osv.Model):
	def print_report_caja(self, cr, uid, ids, context=None):
		return self.pool['report'].get_action(cr, uid, ids, 'sesionespos.report_caja', context=context)
	def print_report_product(self, cr, uid, ids, context=None):
		return self.pool['report'].get_action(cr, uid, ids, 'sesionespos.report_product', context=context)
	def print_report_fecha(self, cr, uid, ids, context=None):
		return self.pool['report'].get_action(cr, uid, ids, 'sesionespos.report_fecha', context=context)
